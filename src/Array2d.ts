...
export class Array2d<T> {
	...
	// unshiftRows() {
	// 	for (let x = 0; x < this.columns; x++) {
	// 		this.values.splice(this.getIndex(x, 0), 0, this.initial as T);
	// 	}
	// 	this.rows += 1;
	// }
	// shiftRows() {
	// 	for (let x = this.columns - 1; x >= 0; x--) {
	// 		this.values.splice(this.getIndex(x, 0), 1);
	// 	}
	// 	this.rows -= 1;
	// }
	// pushRows() {
	...
	// popRows() {
	// 	for (let x = 0; x < this.columns; x++) {
	// 		this.values.splice(this.getIndex(x, this.rows - 1), 1);
	// 	}
	// 	this.rows -= 1;
	// }
	// unshiftColumns() {
	// 	for (let y = this.rows; y >= 0; y--) {
	// 		this.values.splice(this.getIndex(0, y), 0, this.initial as T);
	// 	}
	// 	this.columns += 1;
	// }
	// shiftColumns() {
	// 	for (let y = this.rows; y >= 0; y--) {
	// 		this.values.splice(this.getIndex(0, y), 1);
	// 	}
	// 	this.columns -= 1;
	// }
	// pushColumns() {
	...
	// popColumns() {
	// 	for (let y = this.rows; y >= 0; y--) {
	// 		this.values.splice(this.getIndex(this.columns - 1, y), 1);
	// 	}
	// 	this.columns -= 1;
	// }
}
